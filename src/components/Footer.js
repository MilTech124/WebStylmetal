	...
	<footer>
		<div className='md:flex bg-yellow-500 p-10 justify-evenly'>
			<div className='flex gap-5'>
				...
				<a className='hover:scale-110 transition-all' href='https://www.facebook.com/profile.php?id=100083640406301'><img src="/facebook.svg"/></a>
				<a className='hover:scale-110 transition-all' href='#'><img src="/google.svg"/></a>
			</div>
			<div className='flex gap-5 '>
				<div className='flex gap-2 items-center hover:scale-105 transition-all'>
					<img src="/phone.svg"/>
